...
export default function quienesSomos() {
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-4 pb-20 gap-8 sm:p-20">
        <main className="flex flex-col md:flex-row items-center justify-center gap-8 w-full mt-70  md:mt-80 md:mb-30">
          <h1 className='text-4xl font-semibold text-gray-700 text-center max-w-xl text-shadow-md'>Cómo viajar transformó mi vida y hoy vivo viajando!</h1>
        </main>
      <div className='container flex flex-col items-center justify-center'>
        <NavBar />
          <section className="w-full flex flex-col md:flex-row items-center justify-center gap-8 py-16 mt-50 bg-gray-50 dark:bg-gray-900">
          ...
          <section className="relative w-full flex flex-col items-center justify-center py-16 bg-transparent overflow-hidden">
              <h2 className="text-2xl  font-bold text-center text-gray-700 mb-8 z-10">
                  KUSI significa “Alegría” en lengua quechua y es lo que quiero transmitir en cada experiencia que comparto<br></br> y con la energía que deseo llegar a cada sitio mientras continúo el camino por Latinoamérica: trabajando<br></br> codo a codo con las comunidades, sus emprendimientos y desde su perspectiva.
              </h2>
