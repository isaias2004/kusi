...
export default function Home() {
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-4 pb-20 gap-8 sm:p-20">
      ...
      <main className="flex flex-row items-center justify-center gap-8 mt-150">
        <Image
          src="/monte.jpeg"
          alt="monte"
          width={400}
        ...
        <div className="flex flex-col items-center gap-6 max-w-2xl">
          ...
          height={300}
        />
          <h1 className="text-4xl font-bold text-center text-gray-900 dark:text-white">Kusi Turismo</h1>
          <p className="text-center text-gray-700 dark:text-gray-300 max-w-xl">
            Bienvenidos a Kusi Turismo, tu puerta de entrada a experiencias inolvidables en la naturaleza. Descubre nuestros tours personalizados y vive aventuras únicas con nosotros.
          </p>
          <a href="https://wa.link/9yh9be" target="_blank" rel="noopener noreferrer" className="bg-[#C77A4E] text-white px-6 py-3 rounded-md hover:bg-[#A65E2E] transition">
